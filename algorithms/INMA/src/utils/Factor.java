...
public class Factor {
    ...
    // Tham so chu ki sac
    public static double T = 72000;   //s, thoi gian trien khai mang
...
//    public static final int[] Us = {5, 10, 15, 20, 25};
    public static final int[] Us = {5, 10, 15, 20};
    public static final int[] E_MC_1s = {54000, 81000, 108000, 162000, 216000, 324000};
    public static final int[] E_MC_2s = {13500, 27000, 54000, 81000, 108000};
    public static final int[] Vs = {2, 5, 7, 10, 15, 20};
    public static final int[] Ts = {32000, 72000, 86400, 129600, 172800, 216000, 720000};
...
//public static final double[] Ps = {1, 1.5};
 public static final double[] Ps = {0.25 , 0.5 , 1 , 2 , 4 };
}
